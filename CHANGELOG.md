...
### Added
- **Board Notes** - Add Markdown notes to each board
  - New notes drawer accessible via FileText icon in header
  - Icon highlights when notes exist for current board
  - Full Markdown editor with preview support
  - Auto-save on close with manual save button
  - Notes persist per board in IndexedDB
